...
export const Button = (props: ButtonProps) => {
  ...
  const variantClass = () => {
    if (variant === "primary") {
      return "text-background bg-primary-100 hover:bg-primary-100/80 focus:outline-primary-100";
    } else if (variant === "secondary") {
      return "text-white bg-secondary-100 hover:bg-secondary-100/80 focus:outline-secondary-100";
    } else if (variant === "neutral") {
      return "text-secondary-100 bg-background hover:bg-background/80";
